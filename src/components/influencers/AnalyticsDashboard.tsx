...
import { Users, Heart, MessageCircle, Eye, MapPin } from 'lucide-react';
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <Badge variant="secondary">{influencer.engagement_rate || 0}%</Badge>
          </div>
            ...
            <div className="space-y-2">
              {topLocations.map((location, index) => (
                <div key={index} className="flex justify-between text-sm">
                  ...
                  <span className="font-medium ml-2">{location.count.toLocaleString()}</span>
                </div>
              ))}
            </div>
          ) : (
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              <div className="text-2xl font-bold text-primary">{influencer.follower_count?.toLocaleString() || '0'}</div>
            ...
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              <div className="text-2xl font-bold text-green-500">{influencer.engagement_rate || 0}%</div>
