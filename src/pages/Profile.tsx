...
import { TikTokManager } from '@/components/advertising/TikTokManager';
      ...
      <div className="container mx-auto py-6 space-y-8 max-w-6xl">
        ...
        >
          <div className="bg-card rounded-lg shadow-sm p-1">
            <TabsList className="grid grid-cols-1 md:grid-cols-6 gap-2 p-1">
              ...
              <TabsTrigger value="tiktok" className="flex gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
                <div className="text-sm font-bold">♪</div> TikTok
              </TabsTrigger>
          ...
          <TabsContent value="tiktok" className="space-y-4 animate-fadeIn">
            <TikTokManager />
          </TabsContent>
