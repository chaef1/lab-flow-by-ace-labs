-- Phase 1: Critical Security Fixes - Handle all trigger dependencies
...
DROP TRIGGER IF EXISTS client_comment_notification ON public.client_comments;
DROP FUNCTION IF EXISTS public.notify_team_of_client_comment() CASCADE;
...
-- Update project_assignments policies to be more secure
